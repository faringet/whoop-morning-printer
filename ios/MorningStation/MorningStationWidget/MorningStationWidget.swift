...
struct MorningStationWidgetView: View {
    ...
    private let stationRed = Color(red: 1.0, green: 0.22, blue: 0.12)
        ...
        VStack(alignment: .leading, spacing: 0) {
            HStack(alignment: .center) {
                Text("NEXT\nWAKE")
                    ...
                    .tracking(1.35)
                    .lineSpacing(1)
                    .foregroundStyle(stationRed.opacity(0.76))
                ...
                Text("ARMED")
                    ...
                    .tracking(1.0)
                    .foregroundStyle(stationRed.opacity(0.88))
                    .padding(.horizontal, 7)
                    .padding(.vertical, 4)
                    .background(stationRed.opacity(0.22), in: Capsule())
            }
            ...
            HStack(alignment: .firstTextBaseline, spacing: 7) {
                Image(systemName: "alarm")
                    ...
                    .shadow(color: stationRed.opacity(0.14), radius: 3)
                ...
                Text(wakeTimeText(wakeAt: wakePlan.wakeAt))
                    ...
                    .foregroundStyle(stationRed.opacity(0.94))
                    .shadow(color: stationRed.opacity(0.18), radius: 4)
            }
            ...
            VStack(alignment: .leading, spacing: 2) {
                if countdownHours(wakeAt: wakePlan.wakeAt) > 0 {
                    Text(countdownHoursLine(wakeAt: wakePlan.wakeAt))
                        ...
                        .foregroundStyle(stationRed.opacity(0.86))
                    ...
                    Text(countdownMinutesLine(wakeAt: wakePlan.wakeAt))
                        ...
                        .lineLimit(1)
                        .minimumScaleFactor(0.8)
                        .foregroundStyle(stationRed.opacity(0.80))
                } else {
                    Text(countdownMinutesLine(wakeAt: wakePlan.wakeAt))
                        ...
                        .minimumScaleFactor(0.8)
                        .foregroundStyle(stationRed.opacity(0.94))
                        .shadow(color: stationRed.opacity(0.16), radius: 4)
                }
    ...
    private var notArmedView: some View {
        VStack(alignment: .leading, spacing: 0) {
            ...
            Text("NO WAKE")
                ...
                .foregroundStyle(stationRed.opacity(0.98))
                .shadow(color: stationRed.opacity(0.18), radius: 5)
